  ...
  return (
    <section className="flex justify-center items-center bg-gray-200 py-10 ">
      <div className=" w-full px-4 sm:px-0 sm:w-3/4">
        <h1 className="text-center lg:text-left text-lg md:text-xl lg:text-3xl tracking-wide font-bold text-blueCustom-100 ">
          Manmeet Eccomerce il tuo negozio di elettronica, informatica e gaming,
          telefonia
        </h1>
        <span className="flex flex-col">
          <p className="my-2 text-center md:text-left md:my-4 text-sm sm:text-base lg:text-xl text-blueCustom-100">
            Manmeet Eccomerce è{" "}
